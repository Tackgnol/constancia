...
export function buildBotHttpApp(
  ...
  // Unauthenticated on purpose: a Docker healthcheck running inside the same
  // container has no clean way to carry the bot API key, and a plain
  // liveness ping ("is the HTTP server responding") needs none.
  ...
  app.register(async (protectedApp) => {
    ...
    protectedApp.post('/send-messages', async (request, reply) => {
