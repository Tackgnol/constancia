...
export const getVerifyMagicLinkUrl = (params: VerifyMagicLinkParams,) => {
  ...
  return stringifiedParams.length > 0 ? `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/auth/verify?${stringifiedParams}` : `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/auth/verify`
}
...
export const getLogoutSessionUrl = () => {
  ...
  return `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/auth/logout`
}
...
export const getGetUserUploadSettingsUrl = () => {
  ...
  return `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/users/me/upload-settings`
}
...
export const getCreateMagicLinkUrl = () => {
  ...
  return `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/auth/magic-link`
}
...
export const getCreatePlayerSheetMagicLinkUrl = () => {
  ...
  return `${import.meta.env.SSR ? (process.env.BACKEND_URL ?? 'http://backend:3000') : (import.meta.env.VITE_API_URL ?? 'http://localhost:3001')}/api/v1/auth/player-sheet-link`
}
